...
* adds a search bar to look for titles in the book list.
* adds a button to sort the book list alphabetically by title.
* restyles and resizes stuff for a better experience in general.
* adds a link back to the regular books page from the booktastic books page.<br>
<img width="600px" height="auto" src="https://i.imgur.com/dvqob15.png">

# Stamp Album Page Flipper
for browsing your stamp collection (or someone else's) with ease.<br>
...
* hides the extra "Let's Go" section under your quests.<br>
<img width="600px" height="auto" src="https://i.imgur.com/WtcRNXK.png">

# Gormball MVP
a Gormball companion script for lovers of the game.<br>
...
<img width="400px" height="auto" src="https://i.imgur.com/4pe2a4j.png">
